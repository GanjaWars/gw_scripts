...
var timeout = 0; // таймаут перед показом подсказки (в сек.)
var AUTO_CLOSE = false; // автоматическое закрытие заявки
...
if (root.location.href.indexOf('http://quest.ganjawars.ru/walk.php') >= 0) {
        ...
        for (var i = 0, l = input.length; i < l; i++) {
            ...
            if (input[i].value == 'Начать бой через 15 секунд' && AUTO_CLOSE) {
