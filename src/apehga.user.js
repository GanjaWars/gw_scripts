...
// ===============================================
    ...
    function getMainMenu() {
        ...
        for (var i = 0, l = a.length; i < l; i++) {
            ...
            if (a[i].href == 'http://chat.ganjawars.ru/' && a[i].innerHTML == '<b>Чат</b>') {
    ...
    function getInfo() {
        ...
        for (var i = 1, l = row.length; i < l; i++) {
            ...
            // предмет
            if (row[i].childNodes[1] && row[i].childNodes[1].tagName == 'TD') {
                
                var a = row[i].childNodes[1].firstChild;
                if (a) {
            ...
            // кому
            if (row[i].childNodes[3] && row[i].childNodes[3].tagName == 'TD') {
                
                var a = row[i].childNodes[3].getElementsByTagName('a');
            ...
            // дата возврата
            if (row[i].childNodes[5] && row[i].childNodes[5].tagName == 'TD') {
                
                if (row[i].childNodes[5].firstChild.tagName == 'FONT') {
                    
                    tmp.isOver = 1;
                    
                }
                
                tmp.objDate = row[i].childNodes[5];
...
addToMenu('Возврат', 'http://www.ganjawars.ru/info.rent.php?id=1532371');
    ...
    if (root.location.href.indexOf('ganjawars.ru/info.rent.php?id='+ getCookie('uid')) >= 0) {
        ...
        var getBackItem = function () {
            ...
            if (!info[curItem]) {
                ...
                GM_xmlhttpRequest({
                    method: "GET",
                    url: "http://www.ganjawars.ru/info.php?id="+ info[curItem].persId,
    ...
    if (root.location.href.indexOf('ganjawars.ru/home.senditem.php') >= 0) {
        ...
        if (itemName && (item = getItem(itemName)) !== false ) {
            ...
            if ((inputPrice = getInputByName('sendprice')) !== false ) {
                ...
                if (typeof inputPrice.onclick == 'undefined') {
            ...
            // ставим цену
            if (inputPrice && (inputOwnedTime = getInputByName('owned_time')) !== false && typeof inputOwnedTime.onchange == 'undefined') {
